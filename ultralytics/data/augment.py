...
class Defog:
    ...
    def __call__(self, labels):
        ...
        #img.save('E:/yyj_file/ultralytics-main/runscodeoutput_image.png')
        #imgc=img
        data_hazy = (np.asarray(img) / 255.0)

        #data_hazy = (np.asarray(img))
        ...
        defog = self.defog.to(0)
        defog.load_state_dict(torch.load('E:/yyj_file/ultralytics-main/weight/dehazer1.pth'))
        # print(batch)
        img = defog(data_hazy)
        # i=0
        # #torchvision.utils.save_image(img, 'E:/yyj_file/ultralytics-main/'+str(i)+'.png')
        # i=i+1
        img=img.cpu()

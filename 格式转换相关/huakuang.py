...
label_path = r"E:\soda_test\new_split\yolo_labels\00291__1__924___924.txt"
image_path = r"E:\soda_test\new_split\images\00291__1__924___924.jpg"

#坐标转换，原始存储的是YOLOv5格式
# Convert nx4 boxes from [x, y, w, h] normalized to [x1, y1, x2, y2] where xy1=top-left, xy2=bottom-right
def xywh2xyxy(x, w1, h1, img):
    labels = ['person', 'car','ship']
    label, x, y, w, h = x
    print("原图宽高:\nw1={}\nh1={}".format(w1, h1))
    # 边界框反归一化
    x_t = x*w1
    ...
    # cv2.rectangle(img,(2087,1280,18,19),(0,255,0),2)
    cv2.imshow('show', img)
